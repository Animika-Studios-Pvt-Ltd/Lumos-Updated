...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (menuNavContainer) {
        ...
        topBar.innerHTML = `
      <a href="/careers" class="top-careers-link">Careers</a>
    `;
    ...
    const isCareersPage =
        ...
        path === "/sales-development-representative" ||
        page.startsWith("job-");
    ...
    navbarLinks.forEach((link) => {
        ...
        // Remove hash and get the final part of the URL
    ...
    /* ---------------------------------- SECTION-BASED FALLBACK MATCHING ---------------------------------- */
    if (!matched && page !== "/") {
        if (isCareersPage) {
            careersLinks.forEach((link) => {
                link.classList.add("active");
            ...
            // Check if it's an industry page
                ...
                const indLink = Array.from(
                    ...
                    const href = link.getAttribute("href");
                    return href && href.includes("/industries");
                });
                if (indLink) {
