...
if (mount) {
  ...
  const indianCities = [
    ...
    { name: "Delhi", lat: 28.6139, lon: 77.209, color: 0xf37022 }, // orange
  ...
  indianCities.forEach((city, idx) => {
    ...
    const dotMat = new THREE.PointsMaterial({
      color: city.color,
      size: 0.02, // delicate, high-tech minimal dot size
      transparent: true,
      opacity: 0.95,
      depthWrite: false,
      sizeAttenuation: true,
  ...
  glow.style.cssText =
    "position:absolute;inset:9%;border-radius:50%;box-shadow:0 0 90px rgba(243,112,34,.18), inset 0 0 90px rgba(255,255,255,.08);pointer-events:none;";
